...
export function CollectionModal({ collection, onClose }: CollectionModalProps) {
  ...
  }, [collection.images.length, isFullscreen, onClose]);
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 md:px-8 md:py-6 border-b border-border bg-slate-50/50">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#1E3261] font-serif">{collection.name}</h2>
          ...
          <div className="flex flex-col md:flex-row flex-1 min-h-0 overflow-hidden">
            ...
            <div className="h-[50vh] md:h-auto md:flex-1 bg-slate-100 flex flex-col min-h-0">
              ...
              <div className="relative flex-1 group overflow-hidden bg-slate-200 flex items-center justify-center">
                ...
                <div className="absolute inset-x-4 top-1/2 -translate-y-1/2 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-3 bg-white/80 hover:bg-white text-[#1E3261] rounded-full shadow-lg backdrop-blur-md transition-all"
                  >
                    <ChevronLeft size={24} />
                  </button>
                  <button
              ...
              {/* Thumbnail Bar */}
              <div className="h-24 md:h-32 bg-white border-t border-border p-4 flex gap-3 overflow-x-auto">
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-8">
                  ...
                  {activeTab === "downloads" && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
                      <div className="p-5 border border-slate-200 rounded-xl hover:border-[#1E3261] transition-colors group cursor-pointer">
