...
export function WhyChooseSection() {
  ...
  return (
    <section ref={containerRef} className="h-[150vh] relative bg-slate-50 dark:bg-background border-y border-border/30">
      <div className="sticky top-0 pt-24 md:pt-32 overflow-hidden flex flex-col justify-start pb-10 sm:pb-20 h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center w-full px-4 mb-12 shrink-0 max-w-5xl mx-auto">
          <div className="relative inline-block mt-4 space-y-6">
            <h2 className="text-5xl md:text-6xl lg:text-7xl leading-tight font-bold tracking-tight text-slate-900 dark:text-white">
              Why <span className="font-serif italic text-amber-500 font-medium">Global</span> Importers <br className="hidden md:block" />
              <span className="text-[#0b1c3f] dark:text-[#38bdf8]">Choose</span> <span className="text-red-600 relative inline-block">
                Us.
                <motion.span 
                  animate={{ rotate: 360 }}
            ...
            <motion.div 
              ...
              className="absolute top-8 md:top-12 lg:top-16 -left-8 md:-left-16 lg:-left-24 w-[80px] h-[35px] md:w-[150px] md:h-[65px] rounded-[100px] overflow-hidden shadow-2xl border-4 border-white dark:border-slate-800 hidden sm:block z-20"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-16 md:bottom-24 lg:bottom-28 -right-4 md:-right-12 lg:-right-20 w-[90px] h-[40px] md:w-[180px] md:h-[70px] rounded-[100px] overflow-hidden shadow-2xl border-4 border-white dark:border-slate-800 hidden sm:block z-20"
            >
        ...
        >
          ...
          >
            {pillars.map((pillar, idx) => (
              <div 
                key={idx}
                className="w-[var(--card-w)] shrink-0 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-[32px] p-8 md:p-10 border border-slate-200/60 dark:border-slate-700/60 shadow-[0_8px_40px_rgba(11,28,63,0.06)] relative overflow-hidden group transition-all hover:shadow-[0_20px_60px_rgba(11,28,63,0.12)] min-h-[35vh] flex flex-col justify-center"
              >
                ...
                <div className="text-7xl lg:text-[100px] leading-none font-light text-slate-200 dark:text-slate-800/80 font-serif mb-6 transition-colors duration-500 group-hover:text-amber-500/20 absolute -top-2 right-4 pointer-events-none select-none">
                  {pillar.num}
                </div>
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white font-serif mb-4 relative z-10 pt-6">
                  {pillar.title}
                </h3>
