            ...
            <>
              <motion.div variants={itemVariants} className="hidden md:flex items-center gap-2 lg:gap-3">
                  ...
                  <div className="flex items-center gap-3 mr-2 border-r border-slate-200 pr-4 h-5">
                    <a href="https://www.linkedin.com/company/paperforce-india-llp/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    ...
                    <a href="https://www.instagram.com/paperforceindia?stkn=eG10NWp6NDVhbGQ=" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    <a href="https://www.facebook.com/share/1Xe9TuUfJM/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                      <svg className="w-4 h-4 fill-slate-500 hover:fill-[#1E3261] transition-colors" viewBox="0 0 24 24">
                        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                      </svg>
                    </a>
                    <a href="https://pin.it/6dTgbkvzE" target="_blank" rel="noopener noreferrer" aria-label="Pinterest">
                      <svg className="w-4 h-4 fill-slate-500 hover:fill-[#1E3261] transition-colors" viewBox="0 0 24 24">
