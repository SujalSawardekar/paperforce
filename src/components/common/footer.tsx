        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="flex gap-4 sm:border-r border-blue-900/50 sm:pr-6">
              <a href="https://www.instagram.com/paperforceindia?stkn=eG10NWp6NDVhbGQ=" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-blue-400 hover:text-white transition-colors">
              ...
              <a href="https://www.facebook.com/share/1Xe9TuUfJM/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-blue-400 hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/paperforce-india-llp/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-blue-400 hover:text-white transition-colors">
              ...
              <a href="https://pin.it/6dTgbkvzE" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="text-blue-400 hover:text-white transition-colors">
