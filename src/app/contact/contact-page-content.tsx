      ...
      <section id="map-section" className="relative bg-slate-50 pt-32 pb-32 lg:pb-40 border-t border-slate-100">
        ...
        <Container className="relative z-10">
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true, margin: "-10%" }}
            className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mt-24 max-w-6xl mx-auto relative transform translate-y-24 md:translate-y-20 lg:translate-y-16 z-10"
          >
            {/* Corporate Office */}
            <motion.div 
              variants={cardVariants}
              whileHover={{ y: -8 }}
              className="group bg-white/95 backdrop-blur-xl px-10 pt-10 pb-20 h-[360px] border-t-2 border-transparent hover:border-[#1E3261] border-t-[#1E3261] shadow-[0_25px_60px_rgba(16,35,78,0.15)] flex flex-col text-left transition-all duration-300 rounded-3xl lg:rounded-bl-[100px] lg:rounded-br-3xl lg:rounded-tl-3xl lg:rounded-tr-3xl lg:-translate-x-3 lg:w-[105%] relative overflow-hidden"
            >
            ...
            <motion.div 
              variants={cardVariants}
              whileHover={{ y: -8 }}
              className="group bg-white/95 backdrop-blur-xl px-10 pt-10 pb-20 h-[380px] border-t-2 border-transparent hover:border-[#1E3261] border-t-[#1E3261] shadow-[0_25px_60px_rgba(16,35,78,0.15)] flex flex-col text-left transition-all duration-300 relative z-10 rounded-3xl overflow-hidden"
            >
              <div className="flex items-center gap-3 mb-6 relative z-10">
                <MapPin className="w-5 h-5 text-[#1E3261] group-hover:text-blue-600 group-hover:scale-110 transition-all duration-300" />
